const current = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=bffb752501b51087309150590ce26861";
...
fetch(current)
  ...
  .then((jsObject) => {
    ...
    if(t < 50 && s > 3) {
        document.getElementById("windchill").innerHTML = f.toFixed(0) + "ºF";
    } else {
...
const forecast = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=bffb752501b51087309150590ce26861";
